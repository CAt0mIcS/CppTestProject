...
{
	Image2D::Image2D(const std::string_view filepath)
	{
	...
	void Image2D::CreateImage(uint32_t width, uint32_t height, VkFormat format,
	...
	void Image2D::CopyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height)
	{
		CommandBuffer commandBuffer;
		commandBuffer.Begin();
	...
	VkDescriptorSetLayoutBinding Image2D::GetDescriptorSetLayout(
